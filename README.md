...
Starting from version v1.0.0, this project will match according eBay API's versioning. Should you found a matching 
...
Client::configure(
    new \GuzzleHttp\Client([
        'base_uri' => 'https://api.ebay.com/commerce/taxonomy/v1/',
        'headers'=>[
